...
public abstract class Hilt_CalculatorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CalculatorFragment() {
    super();
  }

  Hilt_CalculatorFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CalculatorFragment_GeneratedInjector) this.generatedComponent()).injectCalculatorFragment(UnsafeCasts.<CalculatorFragment>unsafeCast(this));
    }
  }
